...
class AlipaySubmit {
    ...
    function buildRequestMysign($para_sort) {
        ...
        switch (strtoupper(trim($this->alipay_config['sign_type']))) {
            case "MD5" :
                $mysign = AlipayMd5::md5Sign($prestr, $this->alipay_config['key']);
                break;
            default :
                $mysign = "";
        }
    ...
    function buildRequestForm($para_temp, $method, $button_name) {
        ...
        $sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='" . $this->alipay_gateway_new . "_input_charset=" . trim(strtolower($this->alipay_config['input_charset'])) . "' method='" . $method . "' target='".$this->alipay_config['target']."'>";
