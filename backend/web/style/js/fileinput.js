...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        removeClass: 'btn btn-xs btn-danger btn-custom',
...
//        '    <div class="kv-fileinput-error"></div>\n' +
        '    </div>\n' +
        '</div>';
    tClose = '<div class="close fileinput-remove"><i class="typcn typcn-delete"></i></div>\n';
...
//    tBtnLink = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>';
    ...
    $.fn.fileinputLocales.en = {
        ...
        dropZoneTitle: '拖拽图片到本区域上传 <br>上传图片的格式限制为：JPG，JPEG，PNG，GIF',
